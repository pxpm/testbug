...
class UserCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('name4')->type('text');

        CRUD::column('name3')->type('text');

        CRUD::column('name6')->type('text');
        CRUD::column('name7')->type('text');
        CRUD::column('name8')->type('text');
        CRUD::column('name9')->type('text');
        CRUD::column('name10')->type('text');
        CRUD::column('name11')->type('text');
        CRUD::column('name12')->type('text');
